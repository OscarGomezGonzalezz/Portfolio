<template>
  ...
  <i class="fa-brands fa-github fa-xl github-icon mouse-sm" title="View this site on GitHub"></i>
</a>

<a href="https://www.linkedin.com/in/oscargomezgonzalez/" target="_blank" class="me-5 text-decoration-none"
   aria-label="Find me on LinkedIn">
  <i class="fa-brands fa-linkedin fa-xl linkedin-icon mouse-sm" title="Find me on LinkedIn"></i>
</a>
